...
You can download `TomraConsumerSessionApi.yaml` from:
https://developer.tomra.cloud/api/ConsumerSessionApi (click "Download OpenAPI")

(You will need an account with Tomra to access https://developer.tomra.cloud)
