...
def swagger_csp(view_func=None):
    ...
    if view_func.func.__module__ == "ninja.openapi.views" and view_func.func.__name__ == "openapi_view":
        ...
        return partial(openapi_view_csp, *view_func.args, **view_func.keywords)
